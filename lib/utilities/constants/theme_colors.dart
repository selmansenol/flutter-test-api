...
class ThemeColors {
  static const offWhite = Color(0xffF5F5DC);
  static const creamyWhite = Color(0xffFFFDD0);
  static const white = Color(0xffFFFFFF);
  static const grayWhite = Color(0xffD3D3D3);
  static const silverGray = Color(0xffC0C0C0);
  static const pastelGray = Color(0xffD8D8D8);
  static const grayTertiary = Color(0xff444444);
  static const peachYellow = Color(0xffFFDAB9);
  static const iconColor = Color(0xff1E90FF);
  static const iconColor2 = Color(0xff6DDFDD);
  static const Color lavanderBlue = Color(0xffE6E6FA);
  static const Color nightBlueDark = Color(0xff191970);
  static const Color nightBlueDarkShadow = Color(0xff483D8B);
  static const Color lightBlue = Color(0xff87CEEB);
  static const Color lightBlueGrey = Color(0xffB0C4DE);
  static const Color lightBlueOpen = Color(0xff00AEEF);
